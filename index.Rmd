...
Laporan ini menggunakan data perjalanan historis dari **Cyclistic**, sebuah perusahaan berbagi sepeda fiksi yang berbasis di Chicago. Saya memverifikasi integritas data menggunakan kerangka kerja **ROCCC** untuk memastikan kualitas analisis.
...
4.  **Visualisasi Interaktif & Geospasial (Tableau Dashboard)**
    ...
    **Catatan:** Gambar di bawah adalah pratinjau statis. Silahkan klik link untuk interaksi penuh.
...
[**👉 Klik di sini untuk melihat Dasbor Tableau Interaktif**](https://public.tableau.com/views/All_trip_sepeda/Dashboard1?:language=en-US&:sid=&:redirect=auth&:display_count=n&:origin=viz_share_link)
